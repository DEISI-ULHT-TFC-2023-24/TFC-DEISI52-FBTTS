...
const EstatisticasGolosListaJogos = () => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>{`${teamName} Golos`}</Text>
            <Text style={styles.subtitle}>Últimos 10 jogos da época</Text>
            <TouchableOpacity
            ...
            />
            <Text style={styles.title}>{`Estatísticas de Gols`}</Text>
...
const styles = StyleSheet.create({
    ...
    selectedButton: {
        backgroundColor: '#2196f3', // Altere a cor para o estilo desejado
    },
    jogoItem: {
        marginBottom: 8,
    },
